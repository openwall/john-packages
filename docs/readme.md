...
Please, also check the [Wiki](https://github.com/openwall/john-packages/wiki) for more notes and documentation.

* [Advices To Anyone Facing Opencl Windows Issues](opencl-issues.md)
...
* [How a commit message should be?](commit%20messages.md)
