...
- [ ] Update the commit that will be used to build;
  - Replace all occurrences of `b55f33965491d7af492b9278ca7666c84be25708` with the proper commit hash;
  - Replace all occurrences of `b55f339` with the proper short commit hash;
