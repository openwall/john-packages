...
- [ ] Update the commit that will be used to build;
  - Replace all occurrences of `08757be85f4d88a8fb90664bc5eab9d03ed1af61` with the proper commit hash;
  - Replace all occurrences of `08757be` with the proper short commit hash;
