...
- [ ] Update the commit that will be used to build;
  - Replace all occurrences of `8bce7453f45fe334877013a362b2a5b6a6e8f74d` with the proper commit hash;
  - Replace all occurrences of `8bce745` with the proper short commit hash;
