...
- [ ] Update the commit that will be used to build;
  - Replace all occurrences of `cc59c0f7074cbb284e164b746f3d805cb54e75b2` with the proper commit hash;
  - Replace all occurrences of `cc59c0f` with the proper short commit hash;
