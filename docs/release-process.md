...
- [ ] Update the commit that will be used to build;
  - Replace all occurrences of `104781db9bb87df8d2bc75ad69a013d9dfe470bd` with the proper commit hash;
  - Replace all occurrences of `104781d` with the proper short commit hash;
