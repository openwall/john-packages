...
- [ ] Update the commit that will be used to build;
  - Replace all occurrences of `cf7bcbc57d9c520409b62f0e227eef093fc45676` with the proper commit hash;
  - Replace all occurrences of `cf7bcbc` with the proper short commit hash;
