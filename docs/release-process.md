...
- [ ] Update the commit that will be used to build;
  - Replace all occurrences of `f3517213a576867423cd9de55e6f720b0339c6cd` with the proper commit hash;
  - Replace all occurrences of `f351721` with the proper short commit hash;
