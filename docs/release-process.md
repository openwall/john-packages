...
- [ ] Update the commit that will be used to build;
  - Replace all occurrences of `96c9f627c0995a746d627e21ee46be72c522102a` with the proper commit hash;
  - Replace all occurrences of `96c9f62` with the proper short commit hash;
