...
- [ ] Update the commit that will be used to build;
  - Replace all occurrences of `7c7b5bf91e9ac0c19c40f30d903ea4b04501ba9e` with the proper commit hash;
  - Replace all occurrences of `7c7b5bf` with the proper short commit hash;
