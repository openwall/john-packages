...
- [ ] Update the commit that will be used to build;
  - Replace all occurrences of `7c8b5e3de5d228c8ca91aa03c746cead2cfd4b60` with the proper commit hash;
  - Replace all occurrences of `7c8b5e3` with the proper short commit hash;
