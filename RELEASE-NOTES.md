...
This is release version 'v0.9.9' of `john-packages' itself. August 2024 (version 0.9.9).
...
- \*2john improvements;
  ...
  - Add a modern version of fvde2john.py (.py; Python 3).
